...
class TestLGraphLogger : public TuGraphTest {};

TEST_F(TestLGraphLogger, LGraphLogger) {
    ...
    LoggerManager::GetInstance().Init(log_dir);
    ...
    // Test debug log
    {
        ...
        LoggerManager::GetInstance().SetLevel(severity_level::DEBUG);
    ...
    LoggerManager::GetInstance().Init("", severity_level::INFO);
}
